    ...
    return (
        <div className="px-8 mt-16 mb-4">
            <div className="flex flex-row items-center gap-4">
                ...
                <div className="text-[rgb(30,81,153)] text-[64px] font-bold">Contact</div>
            </div>
            <p className="text-left text-black font-[700] text-[24px] mb-10 w-[24rem] ml-16">Let's grab a coffee and jump on conversation <span className="text-[rgb(42,193,235)]">chat with me.</span></p>
            <div>
                <form>
                    <div className="lg:px-14 w-[25rem] lg:w-[74rem] flex flex-col gap-10">
                        <div className="block lg:flex gap-10 w-[25rem] lg:w-[74rem]">
                            ...
                            <div className="relative p-[1px] box-border bg-white shadow-lg">
                                ...
                                <div className="relative z-10 bg-white rounded-[inherit]">
                                    <input
                                        className="w-[32.5rem] h-[3rem] text-left pl-2"
                                        type="email"
                                        id="email"
                                        name="email"
