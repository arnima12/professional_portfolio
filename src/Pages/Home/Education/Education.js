    ...
    useEffect(() => {
        const fetchUserData = async () => {
            try {
                ...
                if (email) {
                    const response = await fetch(`https://professional-portfolio-backend-gjit.onrender.com/users/${email}`);
                        ...
                        const demoEducation = [
                            {
                                ...
                                startYear: "2020",
                                endYear: "2023",
                                logo: "https://professional-portfolio-backend-gjit.onrender.com/uploads/1726658196668.png",
                                border: true
                            },
                            {
                                id: 2,
