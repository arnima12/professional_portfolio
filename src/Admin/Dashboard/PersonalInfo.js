...
const PersonalInfo = () => {
    ...
    const fetchUserData = async (userEmail) => {
        try {
            const response = await fetch(`https://professional-portfolio-backend-gjit.onrender.com/users/${userEmail}`);
    ...
    const handleAddEducation = async () => {
        ...
        const userEmail = currentUser.email;
        const url = `https://professional-portfolio-backend-gjit.onrender.com/users/${userEmail}`;
        console.log("url", url)
        try {
    ...
    const handleRemoveEducation = async (educationIndex) => {
        try {
            ...
            const userEmail = currentUser.email;
            const url = `https://professional-portfolio-backend-gjit.onrender.com/users/${userEmail}/remove-education`
    ...
    const handleRemoveExperience = async (experienceIndex) => {
        try {
            ...
            const userEmail = currentUser.email;
            const url = `https://professional-portfolio-backend-gjit.onrender.com/users/${userEmail}/remove-experience`
