...
const MyProject = () => {
    ...
    const deleteItem = async (itemType, itemUrl) => {
        try {
            const response = await fetch(`https://professional-portfolio-backend-gjit.onrender.com/users/${userEmail}/delete`, {
                method: 'DELETE',
                headers: {
    ...
    const handleDelete = async (itemType, itemURL, itemTitle) => {
        ...
        try {
            const response = await fetch(`https://professional-portfolio-backend-gjit.onrender.com/users/${userEmail}/store-deleted-item`, {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                },
